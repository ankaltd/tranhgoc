...
export function initCustomDropdown() {
  jQuery("#wep_mega_menu .nav-item").mouseenter(function() {
    const $thisNavItem = jQuery(this);

    jQuery("#wep_mega_menu .nav-item .dropdown-toggle, #wep_mega_menu .nav-item .dropdown-menu").removeClass("show");
    jQuery("#wep_mega_menu .nav-item .dropdown-toggle").attr("aria-expanded", "false");
